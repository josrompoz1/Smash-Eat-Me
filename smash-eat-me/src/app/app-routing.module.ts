...
const routes: Routes = [
  ...
  { path: 'listadousuarios', component: ListadoUsuariosComponent, canActivate: [SesionService] },
  { path: 'crearproducto', component: AddProductoComponent, canActivate: [SesionService] },
  { path: 'listadocupones', component: ListadoCuponesDescuentoComponent, canActivate: [SesionService] },
