...
connection.connect(function(err) {
  ...
  var queries = ["DROP TABLE IF EXISTS UsuarioPrincipal;",
                ...
                "CREATE TABLE Reto (id INT AUTO_INCREMENT, nombre VARCHAR(30) NOT NULL, descripcion VARCHAR(255) NOT NULL, categoria ENUM('Inyeccion de codigo','Autenticacion e identificacion','Control de acceso','Validacion indebida') NOT NULL, dificultad INT NOT NULL, completado BOOLEAN NOT NULL DEFAULT FALSE, PRIMARY KEY(id));",
                ...
                "INSERT INTO Reto (id, nombre, descripcion, categoria, dificultad) VALUES (3, 'XSS almacenado', 'Almacena un script para que se ejecute cuando se acceda al dato', 'Inyeccion de codigo', 3)",
                ...
                "INSERT INTO Reto (id, nombre, descripcion, categoria, dificultad) VALUES (10, 'Fuerza bruta', 'Accede a la cuenta de un usuario probando contraseñas comunes', 'Autenticacion e identificacion', 2)",
                "INSERT INTO Reto (id, nombre, descripcion, categoria, dificultad) VALUES (11, 'Cambia contraseña', 'Cambia la contraseña de otro usuario', 'Autenticacion e identificacion', 4)",
                ...
                "INSERT INTO Reto (id, nombre, descripcion, categoria, dificultad) VALUES (13, 'Credenciales', 'Consigue todos los usuarios y contraseñas de la aplicación', 'Inyeccion de codigo', 5)",
