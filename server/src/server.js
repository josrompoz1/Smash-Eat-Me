...
connection.connect(function(err) {
  ...
  var queries = ["DROP TABLE IF EXISTS UsuarioPrincipal;",
                ...
                "CREATE TABLE Reto (id INT AUTO_INCREMENT, nombre VARCHAR(30) NOT NULL, descripcion VARCHAR(255) NOT NULL, categoria ENUM('Inyeccion de codigo','Criptografia','Autenticacion e identificacion','Control de acceso','Validacion indebida') NOT NULL, dificultad INT NOT NULL, completado BOOLEAN NOT NULL DEFAULT FALSE, PRIMARY KEY(id));",
                ...
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Login', 'Inicia sesión sin conocer la contraseña de un usuario', 'Inyeccion de codigo', 1)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Eliminar datos', 'Elimina todos los datos de una tabla de la base de datos', 'Inyeccion de codigo', 4)",
                ...
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Credenciales', 'Consigue todos los usuarios y contraseñas de la aplicación', 'Criptografia', 3)",
