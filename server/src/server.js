...
connection.connect(function(err) {
  ...
  var queries = ["DROP TABLE IF EXISTS UsuarioPrincipal;",
                ...
                "CREATE TABLE Valoracion (id INT AUTO_INCREMENT, puntuacion INT NOT NULL, resenya TEXT, nombreUsuario VARCHAR(50) NOT NULL, nombreProducto VARCHAR(255) NOT NULL, usuarioId INT NOT NULL, productoPedidoId INT NOT NULL, PRIMARY KEY(id), FOREIGN KEY (usuarioId) REFERENCES Usuario(id) ON DELETE CASCADE, FOREIGN KEY (productoPedidoId) REFERENCES ProductoPedido(id));",
                ...
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Prueba 3', 'Reto de prueba numero 3', 'Autenticacion e identificacion', 2)",
                ...
                "INSERT INTO Solucion (tipo, retoId) VALUES ('Interactiva', 2)",
                "INSERT INTO Solucion (tipo, retoId) VALUES ('Interactiva', 3)",
                "INSERT INTO Solucion (tipo, retoId) VALUES ('Interactiva', 4)",
                "INSERT INTO Solucion (tipo, retoId) VALUES ('No interactiva', 5)",
                "INSERT INTO Solucion (tipo, retoId) VALUES ('No interactiva', 6)",
                "INSERT INTO Solucion (tipo, retoId) VALUES ('Interactiva', 6)",
                "INSERT INTO Solucion (tipo, retoId) VALUES ('No interactiva', 7)",
                ...
                "INSERT INTO Paso (numero, solucion, solucionId) VALUES (3,'Paso numero 3 de la solucion 7',1)",
