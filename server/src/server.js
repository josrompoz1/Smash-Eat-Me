...
connection.connect(function(err) {
  ...
  var queries = ["DROP TABLE IF EXISTS UsuarioPrincipal;",
                ...
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Login', 'Inicia la sesión del usuario ''perico'' sin conocer su contraseña', 'Inyeccion de codigo', 1)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('XSS reflejado', 'Realiza un ataque XSS reflejado', 'Inyeccion de codigo', 1)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('XSS almacenado', 'Almacena un script para que se ejecute cuando se acceda al dato', 'Inyeccion de codigo', 3)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Valoración de 0', 'Realiza una valoración de 0 puntos', 'Validacion indebida', 2)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Usuario ADMIN', 'Registra un usuario con permisos de administración', 'Validacion indebida', 2)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Ver pedidos', 'Mira los pedidos realizados por otro usuario', 'Control de acceso', 2)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Pedido ajeno', 'Realiza un pedido con la sesión de otro usuario', 'Control de acceso', 3)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Reseña 5 estrellas', 'Elimina todas las valoraciones existentes con 5 estrellas', 'Control de acceso', 3)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Cupón 100%', 'Crea un cupón de descuento del 100% y realiza un pedido completamente gratis', 'Control de acceso', 4)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Fuerza bruta', 'Accede a la cuenta de un usuario probando contraseñas comunes', 'Autenticacion e identificacion', 2)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Cambia contraseña', 'Cambia la contraseña de otro usuario', 'Autenticacion e identificacion', 4)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Sesión infinita', 'Haz que la sesión iniciada no caduque nunca o caduque en un largo período de tiempo', 'Autenticacion e identificacion', 4)",
                "INSERT INTO Reto (nombre, descripcion, categoria, dificultad) VALUES ('Credenciales', 'Consigue todos los usuarios y contraseñas de la aplicación', 'Inyeccion de codigo', 5)",
                ...
                "INSERT INTO Solucion (tipo, nombre, retoId) VALUES ('Interactiva', 'Solucion 1', 13)",
                "INSERT INTO Solucion (tipo, nombre, retoId) VALUES ('No interactiva', 'Solucion 2', 13)",
