...
connection.connect(function(err) {
  ...
  var queries = ["DROP TABLE IF EXISTS UsuarioPrincipal;",
                ...
                "CREATE TABLE ProductoPedido (id INT AUTO_INCREMENT, cantidad INT NOT NULL, pedidoId INT NOT NULL, productoOfertadoId INT NOT NULL, PRIMARY KEY(id), FOREIGN KEY (pedidoId) REFERENCES PedidoComida(id), FOREIGN KEY (productoOfertadoId) REFERENCES ProductoOfertado(id) ON DELETE CASCADE);",
